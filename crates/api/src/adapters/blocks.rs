...
//! - TODO Phase 5: Remove after frontend migrates to domain types
...
pub fn block_to_time_entry_dto(
    ...
    Ok(PrismaTimeEntryDto {
        ...
        duration_minutes: (block.duration_secs / 60) as i32,
        notes: Some(format!(
            "Block builder: {}",
        ...
        start_time: None,
        end_time: None,
        duration_sec: Some(block.duration_secs as i32),
        ...
        context_breakdown: Some(map_activities_to_context_parts(&block.activities)),
    })
}
...
) -> Vec<pulsearc_domain::types::database::ContextPart> {
    activities
        .iter()
        .map(|activity| pulsearc_domain::types::database::ContextPart {
            app: activity.name.clone(),
            duration_sec: activity.duration_secs as i32,
