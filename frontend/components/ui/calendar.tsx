  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: 'h-9 w-9 bg-transparent p-0 opacity-50 hover:opacity-100 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-md transition-all inline-flex items-center justify-center cursor-pointer',
        button_next: 'h-9 w-9 bg-transparent p-0 opacity-50 hover:opacity-100 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-md transition-all inline-flex items-center justify-center cursor-pointer',
        ...
        day_button: 'h-9 w-9',
        selected: 'bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 font-medium',
